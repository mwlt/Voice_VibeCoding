...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ipc::commands::start_xiaomi_key_probe,
            ipc::commands::stop_xiaomi_key_probe,
            ipc::commands::get_xiaomi_key_probe_status,
            ipc::commands::clear_xiaomi_key_probe_log,
            ipc::commands::analyze_xiaomi_key_probe,
            ipc::commands::open_xiaomi_key_probe_log,
