...
正式安装包在两边的 Release 页（当前 **v1.3.7**）：

- [Gitee Releases](https://gitee.com/mwlt/remote-voice-vibe-coding/releases/tag/v1.3.7)（国内优先）
- [GitHub Releases](https://github.com/mwlt/Voice_VibeCoding/releases/tag/v1.3.7)

常用文件：

- `Voice VibeCoding_1.3.7_x64-setup.exe`（NSIS）
- `Voice VibeCoding_1.3.7_x64_zh-CN.msi`
